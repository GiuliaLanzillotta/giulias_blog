...
layout: post
tags: "AI-topics"
title: "Why do I work on what I work on (=continual learning)?"
author: "Giulia"
...
<!-- Last week I was at a big ML conference, and, as it is natural to do in such contexts, I was introducing myself by saying what I work on and, if the case permitted, the motivation behind this choice. As I tenaciously leaped from one introduction to the next, sinking into hours of repeated explanations, the idea of elaborating this speech in writing came to my head. So here it is. A final verbalization of my research vision, a *what-and-why* ready to be shared with the *world-wide-web*. That's a lot of "w" words ;) more  -->
<!--Today it seems paramount for any ML researcher who wishes to be taken seriously to have a profile webpage with some sort of description of their past and current projects, their past and current affiliation and their general interests. This is my version of that sort of thing. I leave the boring details to [linkedin].  
-->
<br>
<br>
